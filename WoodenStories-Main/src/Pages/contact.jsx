...
export default function Contact() {
  ...
  useEffect(() => {
    document.title = 'Contact Us | The Wooden Stories';
    const description =
      'Contact The Wooden Stories for questions about handcrafted wooden furniture and home decor. Get in touch via phone, email, or our contact form.';
            ...
            <div className="space-y-6 sm:space-y-8 mt-8 md:mt-0">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-[#2c1910] p-2 sm:p-3 rounded-lg shrink-0">
