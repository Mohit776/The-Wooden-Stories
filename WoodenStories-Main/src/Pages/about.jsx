...
import { Users, Award, Leaf, Clock, Heart, Shield, MapPin, Phone, Mail, CheckCircle, Star, Truck, Clock as ClockIcon, Headphones } from 'lucide-react';
              ...
              >
                <div className="p-5 sm:p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row items-start space-y-3 sm:space-y-0 sm:space-x-4">
                    <div className="flex">
                      <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#d6c088] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                      ...
                      <div className="space-y-1.5 sm:space-y-2">
                        {item.features.map((feature, featureIndex) => (
                          <div key={featureIndex} className="flex items-center space-x-2">
                            <CheckCircle size={14} className="sm:w-4 sm:h-4 text-[#d6c088] flex flex-shrink-0" />
                ...
                <div className="bg-gradient-to-r from-[#2c1910] to-[#654f44] h-2 w-0 group-hover:w-full transition-all duration-700"></div>
              </div>
            ))}
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="h-40 sm:h-48 bg-[#654f44] relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#2c1910] opacity-60"></div>
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="space-y-4 sm:space-y-5 pt-4 sm:pt-6">
          <div className="flex items-start space-x-3 sm:space-x-4">
            <MapPin className="text-[#d6c088] mt-1 flex-shrink-0" size={20} />
            <div>
          ...
          <div className="flex items-start space-x-3 sm:space-x-4">
            <Phone className="text-[#d6c088] mt-1 flex-shrink-0" size={20} />
            <div>
          ...
          <div className="flex items-start space-x-3 sm:space-x-4">
            <Mail className="text-[#d6c088] mt-1 flex-shrink-0" size={20} />
            <div>
