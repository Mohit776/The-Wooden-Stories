...
export default function Footer() {
  return (
    <div>
         ...
         <footer id="contact" className="bg-[#2c1910] py-8 sm:py-12 md:py-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-wood-pattern opacity-5"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="text-center sm:text-left">
              <h3 className="text-xl sm:text-2xl font-serif text-[#f3e9c6] mb-2 sm:mb-4 hover:text-[#d6c088] transition-colors duration-300 cursor-pointer">
                The Wooden Stories
              </h3>
              <p className="text-[#d6c088] text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4 max-w-xs mx-auto sm:mx-0">
            ...
            <div className="text-center sm:text-left">
              <h4 className="text-[#f3e9c6] font-medium mb-2 sm:mb-4 text-base sm:text-lg">Quick Links</h4>
            ...
            <div className="text-center sm:text-left">
              <h4 className="text-[#f3e9c6] font-medium mb-2 sm:mb-4 text-base sm:text-lg">Support</h4>
              <ul className="space-y-2 sm:space-y-3 text-[#d6c088]">
            ...
            <div className="text-center sm:text-left">
              <h4 className="text-[#f3e9c6] font-medium mb-2 sm:mb-4 text-base sm:text-lg">Visit Us</h4>
